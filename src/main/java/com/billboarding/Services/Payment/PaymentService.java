...
public class PaymentService {
    ...
    public PaymentOrderResponse createOrder(CreatePaymentOrderRequest req, User advertiser) {
        ...
        try {
            long amountPaise = Math.round(booking.getTotalPrice() * 100); // Razorpay expects paise
            ...
            // store Razorpay order details in Booking
